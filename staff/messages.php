...
<body class="bg-gray-100 h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col overflow-y-auto h-screen">
        ...
        <nav class="flex-1 p-4">
            <a href="dashboard.php" class="block py-2 px-3 rounded hovere:bg-gray-800">Dashboard</a>
            <a href="messages.php" class="block py-2 px-3 rounded bg-gray-700">Messages</a>
